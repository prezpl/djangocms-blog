...
def get_setting(name):
    ...
    default = {
        "BLOG_IMAGE_THUMBNAIL_SIZE": getattr(
            settings, "BLOG_IMAGE_THUMBNAIL_SIZE", {"size": "120x120", "crop": True, "upscale": False}
        ),
        "BLOG_IMAGE_FULL_SIZE": getattr(
            settings, "BLOG_IMAGE_FULL_SIZE", {"size": "640x120", "crop": True, "upscale": False}
        ),
        ...
        "BLOG_ADMIN_POST_FIELDSET_FILTER": getattr(settings, "BLOG_ADMIN_POST_FIELDSET_FILTER", False),
        "BLOG_AVAILABLE_PERMALINK_STYLES": getattr(settings, "BLOG_AVAILABLE_PERMALINK_STYLES", PERMALINKS),
        ...
        "BLOG_SITEMAP_CHANGEFREQ": getattr(settings, "BLOG_SITEMAP_CHANGEFREQ", SITEMAP_CHANGEFREQ_LIST),
        "BLOG_SITEMAP_CHANGEFREQ_DEFAULT": getattr(settings, "BLOG_SITEMAP_CHANGEFREQ_DEFAULT", "monthly"),
        "BLOG_ENABLE_SEARCH": getattr(settings, "BLOG_ENABLE_SEARCH", True),
        "BLOG_CURRENT_POST_IDENTIFIER": getattr(settings, "BLOG_CURRENT_POST_IDENTIFIER", "djangocms_post_current"),
        "BLOG_CURRENT_NAMESPACE": getattr(settings, "BLOG_CURRENT_NAMESPACE", "djangocms_post_current_config"),
        "BLOG_ENABLE_THROUGH_TOOLBAR_MENU": getattr(settings, "BLOG_ENABLE_THROUGH_TOOLBAR_MENU", False),
        ...
        "BLOG_AUTHOR_POSTS_PLUGIN_NAME": getattr(settings, "BLOG_AUTHOR_POSTS_PLUGIN_NAME", _("Author Blog Articles")),
        "BLOG_AUTHOR_POSTS_LIST_PLUGIN_NAME": getattr(
            settings, "BLOG_AUTHOR_POSTS_LIST_PLUGIN_NAME", _("Author Blog Articles List")
        ),
        "BLOG_TAGS_PLUGIN_NAME": getattr(settings, "BLOG_TAGS_PLUGIN_NAME", _("Tags")),
        "BLOG_CATEGORY_PLUGIN_NAME": getattr(settings, "BLOG_CATEGORY_PLUGIN_NAME", _("Categories")),
        "BLOG_ARCHIVE_PLUGIN_NAME": getattr(settings, "BLOG_ARCHIVE_PLUGIN_NAME", _("Archive")),
        "BLOG_FEED_CACHE_TIMEOUT": getattr(settings, "BLOG_FEED_CACHE_TIMEOUT", 3600),
        "BLOG_FEED_INSTANT_ITEMS": getattr(settings, "BLOG_FEED_INSTANT_ITEMS", 50),
        "BLOG_FEED_LATEST_ITEMS": getattr(settings, "BLOG_FEED_LATEST_ITEMS", 10),
        "BLOG_FEED_TAGS_ITEMS": getattr(settings, "BLOG_FEED_TAGS_ITEMS", 10),
        "BLOG_LIVEBLOG_PLUGINS": getattr(settings, "BLOG_LIVEBLOG_PLUGINS", ("LiveblogPlugin",)),
